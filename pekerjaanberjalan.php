...
<br>
    <div style="margin-left: 105px; margin-top: 35px;">
      ...
      <tr>
      <td style="width: 899px;"><span style="padding-left: 25px;"><i class="fa fa-user-circle" aria-hidden="true"></i> Arsha
       </td>
      </tr>
      <tr>
      <td style="width: 899px;"><span style="padding-left: 25px;">Pekerjaan ditaken sejak tanggal 21 Des 2017.</span></td>
      </tr>
      <tr>
      <td style="width: 899px;"><span style="padding-left: 25px;">
      <div style="text-align: left; padding-left: 25px; padding-top: 20px;">
      <button type="button" class="btn btn-warning"><a href="pekerjaan.php" style="color: #fff;">Periksa</a></button> 
      </div>
      </td>
      </tr>
      </tbody>
